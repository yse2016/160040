...
class IdeanMan implements ActionListener{
	...
	public void actionPerformed( ActionEvent ae ){
		// 配列関連
			// 配列
			String[] idea1 = {"コーヒー","写真","Red Bull","カレー","パズドラ","マカロン","ドルフィン","はやひで","パチンコ","ヘッドホン","清水寺","水","火","江ノ島","モンスターエナジー","ちくわ","ヘアエクステンション"};
			String[] idea2 = {"コーヒー","写真","Red Bull","カレー","パズドラ","マカロン","ドルフィン","はやひで","パチンコ","ヘッドホン","清水寺","水","火","江ノ島","モンスターエナジー","ちくわ","ヘアエクステンション"};
